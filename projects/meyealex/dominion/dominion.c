...
int adventurerCardEffect(int drawntreasure, struct gameState* state, int currentPlayer, int* temphand) {
  int z = 0;
  int cardDrawn;
...
// Feast card effect
int feastCardEffect(int choice1, struct gameState* state, int currentPlayer, int* temphand) {
...
// Minion card effect
int minionCardEffect(int choice1, int choice2, struct gameState* state, int currentPlayer, int handPos) {
  //+1 action
  int i, j;
  state->numActions++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerCardEffect(drawntreasure, state, currentPlayer, temphand);
    ...
    case feast:
      return feastCardEffect(choice1, state, currentPlayer, temphand);
    ...
    case minion:
      return minionCardEffect(choice1, choice2, state, currentPlayer, handPos);
